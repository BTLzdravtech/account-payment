...
class L10nLatamPaymentMassTransfer(models.TransientModel):
    ...
    def _compute_requiere_account_cashbox_session(self):
        # TODO: Odoo BTL - needs to be locked on AR company (one of user's active companies is AR, but the user does not
        #  want this to be applied on other active companies, too)
